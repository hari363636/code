        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('area.update', ['id' => $size->id])}}" method="post">
                  @csrf
                  <div class="row mb-3">
                      <label for="inputText" class="col-sm-2 col-form-label">Area Name</label>
                      <div class="col-sm-10">
                        <input type="text" name="area" class="form-control" value="{{ $size->area }}">
                      </div>
                  </div>
                  <div class="row mb-3">
                      <label for="inputText" class="col-sm-2 col-form-label">Area Name: Arabic</label>
                      <div class="col-sm-10">
                        <input type="text" name="arabic" class="form-control" value="{{ $size->arabic }}">
                      </div>
                  </div>
                  <div class="row mb-3">
