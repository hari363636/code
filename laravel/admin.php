...
Route::prefix('admin')->group(function () {
  ...
  /* HomePage Route*/
        Route::resource('reach-us',\App\Http\Controllers\HomePageController::class);
        ...
        Route::get('/status/change', [\App\Http\Controllers\Admin\StoreController::class, 'status_change'])->name('store.status.change');
        Route::get('/store-details/{id}', [\App\Http\Controllers\Admin\StoreController::class, 'storeDetails'])->name('store.store-details');;
        Route::get('/notification/resend/{id}', [\App\Http\Controllers\Admin\NotificationController::class, 'ResendNotification'])->name('notification.resend');
        Route::get('/notification/change', [\App\Http\Controllers\Admin\NotificationController::class, 'StatusChange'])->name('notification.status.change');
        ...
        Route::controller(SettingsController::class)->prefix('settings')->name('settings.')->group(function () {
            ...
            // sytem update
            Route::put('firebase/update', 'firebaseKeySetup')->name('firebase-setup.update');
            Route::put('firebase-details/update', 'firebaseDetailsUpdate')->name('firebase-details.update');
